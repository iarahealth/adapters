...
export const tabsConfig = (
  ...
  */
  ...
  // const mockConfig = ['open', 'undo'];


  const fileCollection = () => {

    if (config.ribbonConfig?.ribbonItems && (config.ribbonConfig?.ribbonItems.file && config.ribbonConfig?.ribbonItems.file.length > 0))
    {
